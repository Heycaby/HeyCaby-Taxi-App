...
class _DriverDocumentsScreenState extends ConsumerState<DriverDocumentsScreen> {
                ...
                child: Column(
                  ...
                  children: [
                    optionRow(
                      ...
                      DriverStrings.indemnificationQuizQuestion1Options,
                      q1,
                      (v) => q1 = v,
                    ),
                    optionRow(
                      DriverStrings.indemnificationQuizQuestion2,
                      DriverStrings.indemnificationQuizQuestion2Options,
                      q2,
                      (v) => q2 = v,
                    ),
                    optionRow(
                      DriverStrings.indemnificationQuizQuestion3,
                      DriverStrings.indemnificationQuizQuestion3Options,
                      q3,
                      (v) => q3 = v,
                    ),
                    optionRow(
                      DriverStrings.indemnificationQuizQuestion4,
                      DriverStrings.indemnificationQuizQuestion4Options,
                      q4,
                      (v) => q4 = v,
                    ),
                    optionRow(
                      DriverStrings.indemnificationQuizQuestion5,
                      DriverStrings.indemnificationQuizQuestion5Options,
                      q5,
                      (v) => q5 = v,
                    ),
                  ],
  ...
  Widget _progressiveDocumentCard({
        ...
        child: ExpansionTile(
          ...
          trailing: Row(
            ...
            children: [
              ...
              Icon(Icons.expand_more_rounded, color: colors.textSoft),
            ],
          ),
  ...
  List<Widget> _complianceDocumentSections({
    ...
    return [
      ...
      Padding(
        ...
        child: Text(
          DriverStrings.complianceRecommendedNextHint,
          style: typo.bodySmall.copyWith(
            color: colors.textSoft,
            height: 1.35,
          ),
      ...
      Builder(
        builder: (context) {
          ...
          return _progressiveDocumentCard(
            colors: colors,
            typo: typo,
      ...
      Builder(
        builder: (context) {
          ...
          final hasInsuranceOnFile = hasText(snap?.taxiInsuranceProvider) &&
