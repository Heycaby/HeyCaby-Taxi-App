...
8.4 No Long-Term Subscription. HeyCaby does not require a long-term subscription. Access is paid per 7-day period. Drivers can stop before the next 7-day period starts.

8.5 Cancellation. Drivers can cancel at any time. Cancellation stops the next 7-day billing cycle. Access remains active until the current paid 7-day period ends. No refunds are provided for unused days within an active paid period. After cancellation, the driver will lose access to driver features and will no longer receive new ride requests.

8.6 Loss of Founding Member Status. Founding Member status is conditional and may be lost. A driver may lose Founding Member status if they: (a) break platform rules; (b) fail to pay on time; (c) cancel and do not reactivate within the allowed period stated in their driver agreement; (d) remain inactive for an extended period; (e) fail to maintain valid legal documents, permits, insurance, or required taxi credentials; or (f) misuse, abuse, or attempt to manipulate the platform. If a driver loses Founding Member status, HeyCaby may move the driver to the current standard pricing available at that time.
...
ARTIKEL 8 — PROEFTOEGANG, GRONDLEGGERSTOEGANG, BETALING EN ANNULERING
8.1 Proeftoegang. Chauffeurs kunnen beginnen met het gebruiken van HeyCaby zonder vooraf te betalen. De gratis proefperiode is gebaseerd op daadwerkelijk platformgebruik, niet op dagen. De proefperiode eindigt wanneer het eerste van deze twee gebeurtenissen optreedt: (a) 5 geaccepteerde ritten; of (b) €100 in ritwaarde geregistreerd op het Platform, hetzij van voltooide ritten of geaccepteerde ritverzoeken. Een geaccepteerde rit telt onmiddellijk wanneer de Chauffeur op Accepteren tikt, zelfs als de Passagier later annuleert. Dit model is ontworpen om eerlijk te zijn. Eén lange rit kan ongeveer €100 opleveren, terwijl vijf kortere ritten ook ongeveer dezelfde waarde kunnen bereiken.

8.2 Grondleggersaanbod. HeyCaby biedt een beperkt Grondleggersplan voor de eerste 200 goedgekeurde chauffeurs. Grondleggers betalen €30 per 7 dagen, exclusief 21% BTW. Deze prijs is vergrendeld voor Grondleggers zolang: (a) HeyCaby blijft opereren als softwareplatform; (b) de chauffeur zijn account actief houdt; (c) de chauffeur voldoet aan de voorwaarden en chauffeursovereenkomst van HeyCaby; en (d) de chauffeur alle vereiste juridische documenten en vergunningen onderhoudt. Nadat de eerste 200 Grondleggersplaatsen zijn gevuld, behoudt HeyCaby zich het recht voor om prijzen voor nieuwe chauffeurs te verhogen.

8.3 Wanneer Betaling Begint. Een Grondlegger betaalt niet onmiddellijk. Betaling begint pas nadat de proefperiode eindigt. De proefperiode eindigt wanneer het eerste van deze twee gebeurtenissen optreedt: (a) 5 geaccepteerde ritten; of (b) €100 in ritwaarde geregistreerd op het Platform, hetzij van voltooide ritten of geaccepteerde ritverzoeken. Een geaccepteerde rit telt onmiddellijk wanneer de Chauffeur op Accepteren tikt, zelfs als de Passagier later annuleert. Daarna moet de chauffeur €30 plus 21% BTW per 7 dagen betalen om nieuwe ritverzoeken te blijven ontvangen.

8.4 Geen Langdurig Abonnement. HeyCaby vereist geen langdurig abonnement. Toegang wordt betaald per 7-daagse periode. Chauffeurs kunnen stoppen voordat de volgende 7-daagse periode begint.

8.5 Annulering. Chauffeurs kunnen te allen tijde annuleren. Annulering stopt de volgende 7-daagse factureringscyclus. Toegang blijft actief tot het einde van de huidige betaalde 7-daagse periode. Er worden geen terugbetalingen verstrekt voor ongebruikte dagen binnen een actieve betaalde periode. Na annulering verliest de chauffeur toegang tot chauffeursfuncties en ontvangt hij geen nieuwe ritverzoeken meer.

8.6 Verlies van Grondleggersstatus. Grondleggersstatus is voorwaardelijk en kan verloren gaan. Een chauffeur kan zijn Grondleggersstatus verliezen als deze: (a) platformregels overtreedt; (b) niet op tijd betaalt; (c) annuleert en niet binnen de toegestane periode heractiveert zoals vermeld in zijn chauffeursovereenkomst; (d) gedurende een langere periode inactief blijft; (e) niet langer geldige juridische documenten, vergunningen, verzekeringen of vereiste taxicredentials onderhoudt; of (f) het platform misbruikt, oneigenlijk gebruikt of probeert te manipuleren. Als een chauffeur zijn Grondleggersstatus verliest, kan HeyCaby de chauffeur verplaatsen naar de dan geldende standaardprijzen.

8.7 Toekomstige Prijzen. De Grondleggersprijs geldt alleen voor de eerste 200 goedgekeurde chauffeurs. HeyCaby kan hogere prijzen, nieuwe plannen of verschillende toegangstarieven introduceren voor chauffeurs die zich aanmelden nadat de eerste 200 Grondleggersplaatsen zijn ingenomen.
