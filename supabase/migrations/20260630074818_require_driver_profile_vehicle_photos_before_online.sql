-- Driver trust/safety hardening:
-- A driver may not go online without both a public profile photo and at least
-- one vehicle photo. Other onboarding-v2 compliance documents remain
